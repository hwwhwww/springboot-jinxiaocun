...
(function (exports) {
    ...
    var BOOTSTRAP_FILES = [
        'link[rel="stylesheet"][href$="../../../../../bootstrap.css"/*tpa=http://www.17sucai.com/bootstrap.css*/]',
        'link[rel="stylesheet"][href="bootstrap.css"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.css*/]',
        'link[rel="stylesheet"][href$="../../../../../bootstrap.min.css"/*tpa=http://www.17sucai.com/bootstrap.min.css*/]',
        'link[rel="stylesheet"][href="bootstrap.min.css"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.min.css*/]',
        'script[src$="../../../../../bootstrap.js"/*tpa=http://www.17sucai.com/bootstrap.js*/]',
        'script[src="bootstrap.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.js*/]',
        'script[src$="../../../../../bootstrap.min.js"/*tpa=http://www.17sucai.com/bootstrap.min.js*/]',
        'script[src="bootstrap.min.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.min.js*/]'
    ].join(',');
    ...
    function bootstrapScriptsIn($) {
        var longhands = $('script[src*="bootstrap.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.js*/]').filter(function (i, script) {
            var url = $(script).attr('src');
            var filename = filenameFromUrl(url);
            return filename === "bootstrap.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.js*/;
        });
        var minifieds = $('script[src*="bootstrap.min.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.min.js*/]').filter(function (i, script) {
            var url = $(script).attr('src');
            var filename = filenameFromUrl(url);
            return filename === "bootstrap.min.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/bootstrap.min.js*/;
        });
    ...
    addLinter("E007", function lintBootstrapJs($, reporter) {
        ...
        if (scripts.longhands.length && scripts.minifieds.length) {
            reporter("Only one copy of Bootstrap's JS should be included; currently the webpage includes both bootstrap.js and bootstrap.min.js"/*tpa=http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/Only one copy of Bootstrap's JS should be included; currently the webpage includes both bootstrap.js and bootstrap.min.js*/, scripts.longhands.add(scripts.minifieds));
        }
    });
    ...
    addLinter("E016", function lintBtnToggle($, reporter) {
        var badBtnToggle = $('http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/.btn.dropdown-toggle ~ .btn');
    ...
    addLinter("E040", function lintModalHide($, reporter) {
        var modalsWithHide = $('http://www.17sucai.com/preview/482277/2016-03-07/MMSS3/js/.modal.hide');
